        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            {location && (
              <motion.div 
                ...
                className="inline-flex items-center space-x-2 bg-primary/5 text-primary px-4 py-2 rounded-full font-black text-[9px] uppercase tracking-[0.2em] mb-8 border border-primary/10 shadow-sm"
              >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[100px] font-heading font-black text-primary uppercase tracking-tighter leading-[0.85] mb-6">
              Expert <br />
              <span className="text-primary-bright">Cleaning</span> <br />
              {location?.city ? `in ${location.city}` : "Across Nigeria"}
            </h1>
            
            <p className="text-xl font-bold text-secondary-dark/60 uppercase tracking-widest mb-10 max-w-xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start mb-16 w-full sm:w-auto">
              <Link to="/book" className="w-full sm:w-auto">
                <Button className="w-full bg-accent-orange text-white font-black text-[10px] uppercase tracking-[0.2em] px-8 py-4 rounded-none shadow-xl hover:bg-white hover:text-accent-orange transition-all duration-300">
                  Get Free Quote
                </Button>
              </Link>
              <Link to="/cleaner" className="w-full sm:w-auto">
                <Button variant="outline" className="w-full font-black text-[10px] uppercase tracking-[0.2em] px-8 py-4 rounded-none shadow-xl hover:bg-primary hover:text-white transition-all duration-300">
                  Find cleaning jobs
                </Button>
              </Link>
            </div>
          ...
          >
            ...
            <div className="absolute -bottom-10 -right-6 lg:-right-10 w-40 h-40 bg-primary rounded-full border-8 border-white flex flex-col items-center justify-center text-center shadow-2xl transform rotate-12 z-20">
              ...
              <span className="text-[10px] font-black text-white uppercase leading-none px-4">100% Satisfaction Guarantee</span>
            </div>
          </motion.div>
        </div>
      </div>
