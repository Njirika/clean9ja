    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-primary py-24 text-white text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-heading font-black uppercase tracking-tighter mb-4 text-accent-gold">{title}</h1>
        </div>
      </div>
      <div className="container mx-auto px-4 py-20 max-w-3xl">
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-black text-primary uppercase tracking-tighter mb-4">3. Security and Trust</h2>
