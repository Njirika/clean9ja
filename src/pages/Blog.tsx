  ...
  return (
    <div className="min-h-screen bg-secondary/30 pb-32">
      ...
      <div className="container mx-auto px-4 -mt-12 relative z-20">
        {blogs === null ? (
          <div className="text-center py-32 text-gray-400 font-black uppercase tracking-widest text-xs">Loading insights…</div>
        ) : blogs.length === 0 ? (
          <div className="bg-white shadow-2xl border-t-8 border-accent-gold max-w-2xl mx-auto p-16 text-center">
            <h2 className="text-2xl font-black text-primary uppercase tracking-tighter mb-3">No articles yet</h2>
