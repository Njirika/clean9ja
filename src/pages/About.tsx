    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-primary py-32 text-white overflow-hidden relative">
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-6xl md:text-8xl font-heading font-black tracking-tighter mb-8 leading-none">
            We Are <br /> <span className="text-accent-gold italic">Clean9ja.</span>
          </h1>
          <p className="max-w-2xl mx-auto text-xl font-bold text-white/70">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                {[
                  ...
                  <div key={i} className="flex items-center space-x-3">
                    ...
                    <span className="font-black text-primary text-[11px]">{item.label}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-32 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-heading font-black text-primary tracking-tighter mb-4">Work With Us & Learn</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="bg-white p-12 shadow-2xl border-t-8 border-primary relative overflow-hidden group">
              ...
              <h3 className="text-3xl font-black text-primary tracking-tighter mb-6 relative z-10">Industry <br/><span className="text-accent-gold">Insights</span></h3>
              ...
              <Link to="/blog" className="relative z-10">
                <Button className="bg-primary text-white font-black px-10 py-5 rounded-none shadow-xl hover:bg-accent-gold hover:text-primary transition-all">Visit Our Blog</Button>
              </Link>
            </div>
            <div className="bg-white p-12 shadow-2xl border-t-8 border-accent-orange relative overflow-hidden group">
              ...
              <h3 className="text-3xl font-black text-primary tracking-tighter mb-6 relative z-10">Join Our <br/><span className="text-accent-orange">Pro Squad</span></h3>
              ...
              <Link to="/careers" className="relative z-10">
                <Button className="bg-accent-orange text-white font-black px-10 py-5 rounded-none shadow-[0_20px_50px_rgba(255,87,34,0.3)] hover:bg-primary transition-all">Recruitment</Button>
              </Link>
            </div>
          </div>
        </div>
